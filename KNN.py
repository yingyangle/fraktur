...
# def show_confusion(model,labels, predictions,charLabels,n):
#     your_path_here = '/Users/ovoowo/Desktop/fraktur/'
#     plotpath = your_path_here+'plot/'
#     cm = ConfusionMatrix(model, classes=charLabels)
#     cm.score(X_validation, y_validation)
#     cm.poof()
#     # cm = confusion_matrix(labels, predictions)
#     # df_cm = pd.DataFrame([cm], index = charLabels,
#     #               columns = charLabels)
#     # fig = plt.figure(figsize = (10,7))
#     # sn.heatmap(df_cm, annot=True)
#     # plt.savefig(plotpath +'ConfusionMatrix'+str(n)+'.png',dpi=200)
#     return
# show_confusion(labels, predictions,charLabels,n)
